...
const WindChart = lazy(() => import('./components/WindChart.jsx'));
const AIChat = lazy(() => import('./components/AIChat.jsx'));
const SavedTrips = lazy(() => import('./components/SavedTrips.jsx'));
const PDFExportButton = lazy(() => import('./components/PDFExport.jsx'));

const LoaderFallback = () => <div style={{ textAlign: 'center', padding: 20, color: '#5a8da8' }}>Nalaganje...</div>;
